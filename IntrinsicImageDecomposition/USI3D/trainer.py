...
__credits__ = ["Yunfei Liu: https://github.com/DreamtaleCore"]
__date__ = "10/10/22"

'''
This script has the code for the combined network architecture which uses different network blocks including encoder, decoder, generator and discriminator from networks.py
'''
