...
'''
Contains the architecture of the network used in the project
'''
...
class AttentionLayer(nn.Module):
    """
    Class to create the attention layer.
    """
...
class VGGUnrefinedDecoderBatchNorm(nn.Module):
    """
    Class to create image dencoder.
    """
    def __init__(self):
